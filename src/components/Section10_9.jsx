...
export default function Section10_9() {
  return (
    <section className="rt-doctor-porfolio">
      <div className="w-layout-blockcontainer rt-container-medium-v2 w-container">
        <div className="w-layout-vflex rt-doctor-portfolio-main">
          <div className="w-layout-grid rt-doctor-portfolio-top rt-blog-top-gap">
            <div
            ...
            <div className="rt-portfolio-right-grid">
              ...
              >
                ...
                <div className="rt-text-style-h6">
                  10x faster queue management with automated patient tracking
                  and reduced clinic chaos
                </div>
              </div>
            </div>
          </div>
          <div className="w-layout-hflex rt-doctor-portfolio-bottom">
            ...
            >
              <div className="rt-doctor-potfolio-icon-wrapper rt-doctor-potfolio-icon-gap">
                <img
                  ...
                  width={51}
                  height={51}
                  alt="Darmatology icon"
                />
              </div>
              <div className="rt-text-style-h6 rt-h6-heading-gap">
                Smart Queue Tracking
              </div>
              <p className="rt-gap-off rt-secondary-text-color">
                Live updates for patients on when to arrive, eliminating crowded
                waiting rooms.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="rt-gap-off rt-secondary-text-color">
                Keep patients returning with smart SMS reminders and engagement
                loops.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="rt-gap-off rt-secondary-text-color">
                Fast, seamless digital prescriptions that improve the patient
                experience.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="rt-gap-off rt-secondary-text-color">
                Increase repeat visits and reduce no-shows to maximize profitability.
              </p>
            </div>
          </div>
        </div>
