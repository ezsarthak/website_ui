...
export default function ServiceSection1() {
  return (
    ...
    >
      ...
      >
        <img
          src="https://cdn.prod.website-files.com/696f017270bc35c55e784979/698337778e577b294f4d6e16_271ba4d4e5a5d529d38016fdf1d71c48_Service%20Banner%20Background.avif"
        ...
        <div className="w-layout-vflex rt-service-hero-main rt-position-relative rt-mobile-text-center">
          ...
          >
            <div className="w-layout-vflex rt-statisfied-patient-image-wrapper">
              <img
                src="https://cdn.prod.website-files.com/696f017270bc35c55e784979/69783fe9e1caad94b13a2f35_Satisfied%20patient.webp"
                loading="lazy"
                width={115}
                height={35}
            ...
            <div className="w-layout-vflex rt-hero-right-top-right">
              <div className="w-layout-hflex rt-hero-star-wrapper">
                <div>
                  <img
                    src="https://cdn.prod.website-files.com/696f017270bc35c55e784979/69783f94d83ac256daf590c0_Star%20Icon%20(2).svg"
                    loading="lazy"
                    width={18}
                    height={17}
                    alt="Star"
